...
export function ActPane() {
  ...
  return (
    <SettingSection title={t('settings.actMode')}>
      <div className="space-y-4 px-[18px] pb-4 pt-1">
          ...
          <>
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-sm border border-border bg-bg-secondary py-2 pl-9 pr-3 text-[13px] text-text-primary outline-none focus:border-border-focus"
              />
            </div>
